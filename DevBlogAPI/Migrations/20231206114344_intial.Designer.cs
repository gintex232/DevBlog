...
namespace DevsTutorialCenterAPI.Migrations
{
    ...
    [Migration("20231206114344_intial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevsTutorialCenterAPI.Data.Entities.ArticleLike", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DevsTutorialCenterAPI.Data.Entities.CommentLike", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DevsTutorialCenterAPI.Data.Entities.ReportedArticle", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DevsTutorialCenterAPI.Data.Entities.Article", b =>
                {
                    b.HasOne("DevsTutorialCenterAPI.Data.Entities.AppUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DevsTutorialCenterAPI.Data.Entities.ArticleTag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DevsTutorialCenterAPI.Data.Entities.ArticleBookMark", b =>
                {
                    ...
                    b.HasOne("DevsTutorialCenterAPI.Data.Entities.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("DevsTutorialCenterAPI.Data.Entities.CommentLike", b =>
                {
                    b.HasOne("DevsTutorialCenterAPI.Data.Entities.Comment", "Comment")
                        .WithMany()
